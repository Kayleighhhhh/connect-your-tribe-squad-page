...
app.get('/', async function (request, response) {
  ...
  response.render('index.liquid', { persons: personResponseJSON.data, squads: squadResponseJSON.data, indexxed: true })
})

app.get('/andersom', async function (request, response) {
...
app.get('/oudnjong', async function (request, response) {
  ...
  // Render index.liquid uit de views map en geef de opgehaalde data mee als variabele, genaamd persons
  // Geef ook de eerder opgehaalde squad data mee aan de view
  response.render('index.liquid', { persons: personResponseJSON.data, squads: squadResponseJSON.data, oudnjong: true })
})

app.get('/jongnoud', async function (request, response) {
  ...
  // Render index.liquid uit de views map en geef de opgehaalde data mee als variabele, genaamd persons
  // Geef ook de eerder opgehaalde squad data mee aan de view
  response.render('index.liquid', { persons: personResponseJSON.data, squads: squadResponseJSON.data, jongnoud: true })
})
